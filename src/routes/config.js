export default {
    menus: [ // 菜单相关路由
        ...
        {
            key: '/app/ui', title: '资源管理', icon: 'scan',component:'',
            subs: [
        ...
        {
            key: '/app/table', title: '轮播图管理', icon: 'copy',component:'Banners',
            // subs: [
        ...
        {
            key: '/app/form', title: '模块管理', icon: 'edit',component: 'BasicForm',
            // subs: [
            //     { key: '/app/form/basicForm', title: '基础表单', component: 'BasicForm'},
            // ],
        },
        {
            key: '/app/chart', title: '导航栏管理', icon: 'area-chart',component: 'NaviManage',
            // subs: [
